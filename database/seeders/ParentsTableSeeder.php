...
class ParentsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $my_parents->password = Hash::make('parent123');
        $my_parents->Name_Father = ['en' => 'helalalwazzan', 'ar' => 'هلال الوزان'];
        ...
        $my_parents->Address_Father ='صنعاء';
        ...
        $my_parents->Address_Mother ='صنعاء';
        $my_parents->save();
